...
- consent-manager: mounts a site-owned Cloudflare Web Analytics loader that injects its deferred beacon only after c15t measurement consent. If measurement consent is later revoked, it removes the owned tag as a best effort and prevents reinjection for the remainder of the document.
