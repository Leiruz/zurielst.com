...
- theme-switcher: uses compact dossier letterforms so the landing route does not load an icon-library runtime, and adds a lazy WebAudio direction cue that safely falls back to silence.
